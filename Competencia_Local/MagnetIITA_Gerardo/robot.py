...
class Robot:
    ...
    def lookAtAngle(self, a, velocidad = MAX_SPEED):
        ra = self.getRotation()
        ...
        self.leftVelocity = vl * velocidad
        self.rightVelocity = vr * velocidad
    ...
    def moveToPoint(self, point, velocity = MAX_SPEED):
        position = self.getPosition()
        rx = position.x
        ry = position.y
        px = point.x
        ...
        self.leftVelocity = vl * velocity
        self.rightVelocity = vr * velocity
